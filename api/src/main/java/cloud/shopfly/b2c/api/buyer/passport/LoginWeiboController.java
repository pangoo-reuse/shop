...
public class LoginWeiboController {
    ...
    public Map h5Login(@NotEmpty(message = "code cant be empty")String code,@NotEmpty(message = "uuid cant be empty") String uuid,@NotEmpty(message = "redirect_uri cant be empty")String redirect_uri){
